 ...
 * Description:
 **/
public class FdbdServerThread extends Thread {
    ...
    public FdbdServerThread(int port) {
        this.port = port;
    }
    ...
    public void run() {
        ...
        System.out.println(TAG + " getInetAddress = " + serverSocket.getInetAddress().toString());
        System.out.println(TAG + " port = " + serverSocket.getInetAddress().getCanonicalHostName());
        System.out.println(TAG + " port = " + serverSocket.getLocalPort());
